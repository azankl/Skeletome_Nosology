...
#then fix errors:
#need to decide when these errors should be fixed, before or after comparing and joining with other data like G2P and PanelApp

#there are multiple ways to fix errors, I will show a few examples

#Fix errors with rows_upate
#change NOS_Gene IFT40 to IFT140
nosology <- nosology %>%
